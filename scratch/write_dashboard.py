...
<section class="content">
  <div class="container-fluid">
    ...
    <!-- Row 1: Follow-up urgency small-box cards -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-danger">
          <div class="inner">
            <h3>{{ followups_today|default:"0" }}</h3>
            <p>Follow-up Due Today</p>
          </div>
          <div class="icon"><i class="fas fa-fire"></i></div>
          <a href="{% url 'follow_up_report' %}" class="small-box-footer">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-orange">
          <div class="inner">
            <h3>{{ followups_7|default:"0" }}</h3>
            <p>Follow-up Next 7 Days</p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-warning">
          <div class="inner">
            <h3>{{ followups_15|default:"0" }}</h3>
            <p>Follow-up Next 15 Days</p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-success">
          <div class="inner">
            <h3>{{ followups_30|default:"0" }}</h3>
            <p>Follow-up Next 30 Days</p>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-success">
          ...
          <a href="{% url 'booking_list' %}" class="small-box-footer">
            More info <i class="fas fa-arrow-circle-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="small-box bg-warning">
          <div class="inner">
            <h3>{{ total_cancellations|default:"0" }}</h3>
...
(function () {
  ...
  if (bCtx) {
    new Chart(bCtx, {
      ...
      data: {
        labels: mL,
        datasets: [
          { label: 'Bookings', data: mB, backgroundColor: 'rgba(60,141,188,0.25)', borderColor: '#3c8dbc', borderWidth: 2, borderRadius: 4, yAxisID: 'y', type: 'bar' },
          { label: 'Revenue', data: mR, borderColor: '#00a65a', backgroundColor: 'rgba(0,166,90,0.08)', borderWidth: 2, pointRadius: 4, pointBackgroundColor: '#00a65a', tension: 0.4, fill: true, type: 'line', yAxisID: 'y1' }
        ]
      },
      options: {
        ...
        plugins: {
          ...
          tooltip: { callbacks: { label: function(c) { return c.datasetIndex === 1 ? ' \\u20b9' + c.parsed.y.toLocaleString('en-IN') : ' ' + c.parsed.y + ' bookings'; } } }
        },
        scales: {
          y:  { beginAtZero: true, ticks: { stepSize: 1, font: { size: 10 } }, grid: { color: '#f4f4f4' }, title: { display: true, text: 'Bookings', font: { size: 10 } } },
          y1: { beginAtZero: true, position: 'right', grid: { drawOnChartArea: false }, ticks: { font: { size: 10 }, callback: function(v) { return v >= 100000 ? '\\u20b9' + (v/100000).toFixed(1) + 'L' : '\\u20b9' + v; } }, title: { display: true, text: 'Revenue', font: { size: 10 } } }
        }
      }
    });
  }
  ...
  if (pCtx && pL.length > 0) {
    ...
    new Chart(pCtx, {
      type: 'doughnut',
      data: { labels: pL, datasets: [{ data: pC, backgroundColor: pal.slice(0, pL.length), borderWidth: 2, borderColor: '#fff' }] },
      options: { responsive: true, maintainAspectRatio: false, plugins: { legend: { position: 'bottom', labels: { font: { size: 10 }, padding: 10, boxWidth: 12 } } }, cutout: '60%' }
    });
  }
})();
</script>
